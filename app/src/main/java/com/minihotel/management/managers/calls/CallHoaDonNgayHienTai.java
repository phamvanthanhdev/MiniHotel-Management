...
public class CallHoaDonNgayHienTai {
    public static void getHoaDonNgayHienTai(IHoaDonNgayHienTai callback){
        ApiService.apiService.getHoaDonNgayHienTai().enqueue(new Callback<List<HoaDonNgay>>() {
            @Override
