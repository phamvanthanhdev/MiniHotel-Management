...
public class CallPhieuDatTheoNgay {
    public static void getPhieuDatTheoNgay(String ngay, IPhieuDatTheoNgay callback){
        ApiService.apiService.getPhieuDatTheoNgay(ngay).enqueue(new Callback<List<PhieuDatTheoNgay>>() {
            @Override
