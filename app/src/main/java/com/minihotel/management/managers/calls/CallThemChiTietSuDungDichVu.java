...
public class CallThemChiTietSuDungDichVu {
    public static void themChiTietSuDungDichVu(ChiTietSuDungDichVuRequest request, IThemChiTietSuDungDichVu callback){
        ApiService.apiService.themChiTietSuDungDichVu(request).enqueue(new Callback<List<ChiTietSuDungDichVu>>() {
            @Override
